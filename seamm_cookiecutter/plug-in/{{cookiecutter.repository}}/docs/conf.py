...
# -*- coding: utf-8 -*-
#
# {{ cookiecutter.repository }} documentation build configuration file,
...
import {{ cookiecutter.repository }}  # noqa: E402
...
version = {{ cookiecutter.repository }}.__version__
# The full version, including alpha/beta/rc tags.
release = {{ cookiecutter.repository }}.__version__
...
htmlhelp_basename = '{{ cookiecutter.repository }}doc'
...
# [howto/manual]).
latex_documents = [
    ('index', '{{ cookiecutter.repository }}.tex',
