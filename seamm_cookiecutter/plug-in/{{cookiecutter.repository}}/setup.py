...
{%- if cookiecutter.license in license_classifiers %}
    ...
    url='https://github.com/{{ cookiecutter.organization }}/{{ cookiecutter.repository }}',
    ...
    packages=find_packages(include=['{{ cookiecutter.repository }}']),
...
{%- endif %}
    ...
    entry_points={
        'org.molssi.seamm': [
            '{{ cookiecutter.step }} = {{ cookiecutter.repository }}:{{ cookiecutter.class_name }}Step',
        ],
        'org.molssi.seamm.tk': [
            '{{ cookiecutter.step }} = {{ cookiecutter.repository }}:{{ cookiecutter.class_name }}Step',
        ],
