...
"""Description of the computational models for {{ cookiecutter.class_name }}.
...
"""Description of the {{ cookiecutter.class_name }} keywords.
...
"""Properties that {{ cookiecutter.class_name }} produces.
