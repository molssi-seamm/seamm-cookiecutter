...
"""The graphical part of a {{ cookiecutter.substep }} step"""
...
class Tk{{ cookiecutter.class_name }}(seamm.TkNode):
    """
    The graphical part of a {{ cookiecutter.substep }} step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in {{ cookiecutter.substep }}_parameters.py
    ...
    def create_dialog(self):
        ...
        based on what is specified in the {{ cookiecutter.substep }}_parameters
        module.
        ...
        frame = super().create_dialog(title=" {{- cookiecutter.substep -}} ")
    ...
    def reset_dialog(self, widget=None):
        ...
        {{ cookiecutter.substep }}_parameter.
