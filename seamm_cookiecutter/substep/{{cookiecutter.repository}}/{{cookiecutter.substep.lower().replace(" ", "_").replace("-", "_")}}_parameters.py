# -*- coding: utf-8 -*-
"""
Control parameters for the {{ cookiecutter.substep }} step in a SEAMM flowchart
"""
...
class {{ cookiecutter.class_name }}Parameters(seamm.Parameters):
    ...
    See Also
    --------
    {{ cookiecutter.class_name }}, Tk{{ cookiecutter.class_name }}, {{ cookiecutter.class_name }} {{ cookiecutter.class_name }}Parameters, {{ cookiecutter.substep }}Step
    """
