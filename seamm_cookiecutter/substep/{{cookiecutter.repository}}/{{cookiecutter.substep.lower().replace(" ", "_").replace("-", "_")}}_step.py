...
class {{cookiecutter.class_name}}Step(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the {{cookiecutter.substep}} step. It must be
    ...
    my_description = {
        "description": "An interface for {{cookiecutter.substep}}",
        "group": "Calculations",
        "name": "{{cookiecutter.substep}}",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return {{cookiecutter.repository}}.{{cookiecutter.class_name}}(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return {{cookiecutter.repository}}.Tk{{cookiecutter.class_name}}(canvas=canvas, **kwargs)
